...
Pillaiyar Nonbu 2026 will be held on Saturday, December 19, 2026, in the San Francisco Bay Area. Specific venue address and entry details are shared directly with registered families prior to the event.
</div>
</div>
...
<li>Overseas printing, tariffs, and international shipping costs have increased significantly. Moving to a digital directory avoids major printing overhead and keeps registration fees affordable for all families.</li>
<li>We're transitioning to NCNA’s official digital address book initiative (web and mobile app), allowing families to keep their profile updated securely (<a href="https://ab.encna.org" target="_blank">https://ab.encna.org</a>).</li>
<li>Built with paid service partners, the app adheres to industry security standards verified by software engineering professionals with explicit consent required from every member before contact details and photos are displayed.</li>
</ul>
</div>
</div>
</div>

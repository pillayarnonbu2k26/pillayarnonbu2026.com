...
<div class="faq-item" onclick="toggleFaqItem(this)">
<div class="faq-question">
<span>Why is there no printed address book for PN 2026?</span>
<svg class="chevron" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"></polyline></svg>
</div>
<div class="faq-answer">
...
<div class="faq-answer">
<ul style="margin-left: 1.25rem; display: flex; flex-direction: column; gap: 0.45rem;">
<li><strong>Beneficiary List:</strong> Similar to last year, the PN 2026 team maintains the established list of designated charitable options (including <strong>NSNA (including special projects)</strong>, <strong>NCNA</strong>, and <strong>local community beneficiaries</strong>).</li>

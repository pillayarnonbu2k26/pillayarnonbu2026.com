...
Pillayar Nonbu 2026 will be held on <strong>Saturday, December 19th, 2026</strong>, in the <strong>San Francisco Bay Area</strong>. Specific venue address and entry details are shared directly with registered families prior to the event.
</div>
</div>
...
<div class="faq-answer">
Each year, a new set of <strong>six host families</strong> is selected by random draw during Pillayar Nonbu to organize the subsequent year's event. Families who have previously organized are excluded from the draw to maximize community participation — as tracked by NCNA database records dating back to 1991.
</div>
</div>
